...
function styleX(value, chosenXAxis) {
  ...
  //ATTRACTIVENESS RATE
  else if (chosenXAxis === 'attractivenessRate') {
    return `${value}`;
  }
  else {
    return `${value}`;
...
function updateToolTip(chosenXAxis, chosenYAxis, circlesGroup) {
  ...
  //AR
    ...
    var xLabel = 'Attractiveness Rate:';
  }
  //Y label
  //CRpClick
  ...
  //TIMEBEFOREFIRSTCLICK
    ...
    var yLabel = 'Time Before First Click:';
  }
...
d3.csv('./assets/data/data.csv').then(function (censusData) {
  ...
  var clickRateLabel = xLabelsGroup.append('text')
    ...
    .attr('x', 0)
    .attr('y', 20)
    .attr('value', 'Click Rate')
    .text('Click Rate (%)');

  var arLabel = xLabelsGroup.append('text')
    .classed('aText', true)
    ...
    .on('click', function () {
      ...
      if (value != chosenXAxis) {
        ...
        if (chosenXAxis === 'clickRate') {
          ...
          clickRateLabel.classed('active', false).classed('inactive', true);
